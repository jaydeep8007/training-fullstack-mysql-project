  ...
  return (
    <div className="w-full max-w-full mx-auto bg-background border border-border rounded-lg px-4 md:px-6 py-6 shadow-sm">
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* Password */}
        <div>
          <label className="block text-xs text-gray-600 font-medium mb-1">Password</label>
          <input
            type="password"
            name="cus_password"
        ...
        {/* Confirm Password */}
        <div>
          <label className="block text-xs text-gray-600 font-medium mb-1">Confirm Password</label>
          <input
            type="password"
